...
<plist version="1.0">
<!--
  vs_dark — GENERATED by theme/generate.sh. Edit theme/palette.sh, not this file.
  Rebuild bat's cache after a change: bat cache --build
  There is a separate bat-light.tpl because the light theme declares scopes this
  one leaves to inherit; the two are not structurally the same file.
-->
<dict>
  <key>name</key>
  <string>vs_dark</string>
  <key>settings</key>
  <array>
    ...
    <dict>
      ...
      <dict>
        ...
        <key>caret</key>         <string>${ISG_CURSOR}</string>
    ...
    <dict>
      <key>name</key><string>Boolean / language constant</string>
      <key>scope</key><string>constant.language, support.constant, constant.other</string>
      <key>settings</key><dict><key>foreground</key><string>${ISG_ACCENT}</string></dict>
    </dict>

    <!-- Keywords / storage / types (all blue, matching vs_dark.vim) -->
    <dict>
    ...
    <!-- Functions: plain foreground (matches vs_dark.vim) -->
    <dict>
