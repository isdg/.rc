...
-- Both symbol pickers are fzf, not telescope (lua/lsp_picker.lua): nvim's client
-- answers either way, but a real fzf process inherits the shared opts file, so
-- these get the same theme, M-j jump and M-d/M-u/M-g keys as every picker here.
lmap("n", "e", function() require("lsp_picker").document() end,
    { desc = "Document symbols" })
lmap("n", "E", function() require("lsp_picker").workspace() end,
