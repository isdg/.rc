...
description: Use when designing or building a feature, fix, or refactor, or when weighing a trade-off in an API, interface, or abstraction's design.
---

# Software philosophy

These principles come first when designing and building anything. Delivery
concerns (small, focused PRs, see [[pr-conventions]]) never trim them: a
feature designed under these principles gets *divided* into several PRs for
